...
PairEAMSpline::PairEAMSpline() : PairEAM()
{
  //ctor
}
...
PairEAMSpline* PairEAMSpline::clone() const
{
  return new PairEAMSpline(*this);
}
...
bool PairEAMSpline::check_pair(Atom *atom, Potential *pot)
{
  int typ1 = atom->typ;
  int typ2 = neigh->typ;
